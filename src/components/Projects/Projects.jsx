      ...
      <section className='projects' id='projects'>
          <div className="container projects__container">
              ...
              <div className='projects-grid'>
                  <Card id={1} image = {p1} title='Responsive React App' link='https://molex0.github.io/ResponsiveReactApp/'/>
                  <Card id={2} image = {p2} title='Meme Generator'link='https://molex0.github.io/meme-generator/'/>
                  <Card id={3} image = {p3} title='Responsive App' link='https://molex0.github.io/ProjectCSS-host/'/>
                  <Card id={4} image = {p4} title='React Tenzies Game'link='https://molex0.github.io/ReactTenziesGame/'/>
              </div>
          </div>
      </section>
  )
